...
import { TeamFormValues } from './Team'

// Social link item component - memoized to prevent unnecessary re-renders
export const SocialLinkItem = memo(
  ({
    index,
    socialIndex,
    control,
...
// Social links section component - also memoized for better performance
export const SocialLinksSection = memo(
  ({ index, form, control }: { index: number; form: any; control: Control<TeamFormValues> }) => {
    // Get social links only when needed using a callback to avoid unnecessary re-renders
